...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="fixed top-2 left-1/2 transform -translate-x-1/2 w-[450px] rounded-2xl bg-black border border-gray-700 shadow-md flex justify-center space-x-6 px-8 py-6 text-white"
    >
      {children}
    </nav>
  );
